...
describe("Record Store", function (){
    ...
    before(function() {
      record1 = new Record("The Cure", "The Head on The Door", "12inch vinyl", "alternative/indie", 5.00);
      record2 = new Record("Converge", "Jane Doe", "CD","metal/harcore", 7.00);
      record3 = new Record("Basic Channel", "BCD-1", "CD", "techno", 10.00);
      record4 = new Record("Various Artists", "Drive OST", "12inch vinyl x 2", "soundtrack", 20.00);
